...
// const uni = graduates.filter((student) => {
...
zooAnimals.filter((animal) => {
  if (animal.population < 5) {
    largerPopulation.push(`${animal.animal_name} has a population lower than 5!`);
  }
});
...
var populationTotal = zooAnimals.reduce((total, animal) => {
